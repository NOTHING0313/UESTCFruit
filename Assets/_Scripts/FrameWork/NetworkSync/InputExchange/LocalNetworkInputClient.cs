...
{
    /// <summary>
    /// Raw UDP 网络输入客户端：发送自己的 PlayerInputSnapshot，并接收服务器 Authority Frame。
    /// </summary>
    public sealed class LocalNetworkInputClient : INetworkInputClient
    {
        ...
        /// <summary>Raw UDP 无主动 Pump 需求，仅统一公共客户端调用面。</summary>
        public void Tick()=>ThrowIfDisposed();
