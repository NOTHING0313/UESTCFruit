...
{
    private readonly EntityComponentAction<PlayerInputSnapshotComponent, MoveSpeedComponent, VelocityComponent> _inputMoveAction;
    ...
    private void ApplyInputMove(Entity entity, ref PlayerInputSnapshotComponent input, ref MoveSpeedComponent speed, ref VelocityComponent velocity)
    {
