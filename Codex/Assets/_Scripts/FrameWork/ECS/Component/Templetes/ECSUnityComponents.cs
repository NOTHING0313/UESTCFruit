...
/// </summary>
public struct ViewComponent : IComponentData, IRollbackTransientComponent
{
...
/// <summary>
/// View 的稳定 Prefab 描述。
/// 仅保存可确定的 prefabID，用于 Rollback 后重建表现；不保存 GameObject / Transform / viewID。
/// </summary>
public struct ViewPrefabComponent : IComponentData, ILogicChecksumIgnoredComponent
{
    /// <summary>ViewManager 中注册的 Prefab ID。</summary>
    public int prefabID;

    /// <summary>创建稳定 View Prefab 描述。</summary>
    public ViewPrefabComponent(int prefabID)
    {
...
/// </summary>
public struct PrefabViewRequestComponent : IComponentData, IRollbackTransientComponent
{
    /// <summary>ViewManager 中注册的 Prefab ID。</summary>
    public int prefabID;
...
/// </summary>
public struct ViewDestroyRequestComponent : IComponentData, IRollbackTransientComponent
{
}
